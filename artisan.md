...
- [مقدمة](#introduction)
    - [تينكر (بيئة التشغيل التفاعلية)](#tinker)
- [كتابة الأوامر](#writing-commands)
    - [توليد الأوامر](#generating-commands)
    - [هيكل الأمر](#command-structure)
    - [أوامر الإغلاق](#closure-commands)
    - [أوامر العزل](#isolatable-commands)
- [تحديد توقعات الإدخال](#defining-input-expectations)
    - [الوسائط](#arguments)
    - [الخيارات](#options)
    - [مصفوفات الإدخال](#input-arrays)
    - [وصف الإدخال](#input-descriptions)
    - [طلب الإدخال المفقود](#prompting-for-missing-input)
- [إدخال وإخراج الأمر](#command-io)
    - [استرجاع الإدخال](#retrieving-input)
    - [طلب الإدخال](#prompting-for-input)
    - [كتابة الإخراج](#writing-output)
- [تسجيل الأوامر](#registering-commands)
- [تنفيذ الأوامر برمجيًا](#programmatically-executing-commands)
    - [استدعاء الأوامر من أوامر أخرى](#calling-commands-from-other-commands)
- [معالجة الإشارات](#signal-handling)
- [تخصيص القوالب](#stub-customization)
- [الأحداث](#events)

<a name="introduction"></a>
## مقدمة

Artisan هو واجهة سطر الأوامر المضمنة في Laravel. يتواجد Artisan في جذر تطبيقك كنصي `artisan` ويوفر عددًا من الأوامر المفيدة التي يمكن أن تساعدك أثناء بناء تطبيقك. لعرض قائمة بجميع أوامر Artisan المتاحة، يمكنك استخدام الأمر `list`:

```shell
php artisan list
```

كل أمر يتضمن أيضًا شاشة "المساعدة" التي تعرض وتوصف الوسائط والخيارات المتاحة للأمر. لعرض شاشة المساعدة، قم بإضافة `help` قبل اسم الأمر:
...
إذا كنت تستخدم [Laravel Sail](/docs/{{version}}/sail) كبيئة تطوير محلية، تذكر استخدام سطر الأوامر sail لاستدعاء أوامر Artisan. ستقوم Sail بتنفيذ أوامر Artisan داخل حاويات Docker التابعة لتطبيقك:
